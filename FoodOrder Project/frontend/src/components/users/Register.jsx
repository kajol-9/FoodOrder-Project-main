...
const Register = () => {
  ...
  const submitHandler = (e) => {
    ...
    // Debugging: Log the current state before submission
    console.log("User data on submit:", user);
    console.log("Avatar path on submit:", avatar);
    ...
    // Handle avatar path validation
    if (avatar !== "") {
      formData.set("avatar", avatar);
    } else {
      console.warn("No avatar provided, using default image path");
  ...
  const onChange = (e) => {
    if (e.target.name === "avatar") {
      ...
      // Debugging: Log avatar file change
